...
service Remote { 
    ...
    set<binary> zrangeWithScores(1:string cluster, 2: string key, 3:i64 start, 4:i64 e);
    set<binary> zrevrangeWithScores(1:string cluster, 2: string key, 3:i64 start, 4:i64 e);
    ...
    list<string> sortParams(1:string cluster, 2: string key, 3:binary sortingParameters);
    ...
    set<binary> zrangeByScoreWithScores1(1:string cluster, 2: string key, 3:double min, 4:double max);
    set<binary> zrevrangeByScoreWithScores1(1:string cluster, 2: string key, 3:double max, 4:double min);
    set<binary> zrangeByScoreWithScores2(1:string cluster, 2: string key, 3:double min, 4:double max, 5:i32 offset, 6:i32 count);
    set<string> zrevrangeByScore(1:string cluster, 2: string key, 3: string max, 4: string min, 5: i32 offset, 6: i32 count);
    set<binary> zrangeByScoreWithScores3(1:string cluster, 2: string key, 3: string min, 4: string max);
    set<binary> zrevrangeByScoreWithScores2(1:string cluster, 2: string key, 3: string max, 4: string min);
    set<binary> zrangeByScoreWithScores4(1:string cluster, 2: string key, 3: string min, 4: string max, 5: i32 offset, 6: i32 count);
    set<binary> zrevrangeByScoreWithScores3(1:string cluster, 2: string key, 3: double max, 4: double min, 5: i32 offset, 6: i32 count);
    set<binary> zrevrangeByScoreWithScores4(1:string cluster, 2: string key, 3: string max, 4: string min, 5: i32 offset, 6: i32 count);
    ...
    i64 linsert(1:string cluster, 2: string key, 3: i32 where, 4: string pivot, 5: string value);
